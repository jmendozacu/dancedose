...
($context["description"] ?? null) && ($this->getAttribute(($context["description"] ?? null), "position", array()) == "invisible"))) ? ("sr-only") : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/bootstrap/templates/bootstrap/bootstrap-panel.html.twig", "/home/mxubgpot/public_html/themes/bootstrap/templates/bootstrap/bootstrap-panel.html.twig");
    }
}
