...
/* {# inline_template_start #}by {{ name }} | {{ created }} */
class __TwigTemplate_9b54ad93c12d1b12fd96356d8f17796e51b89dd8edbef70f74a20a2904679efd extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}by {{ name }} | {{ created }}";
    }
    ...
    {
        return new Twig_Source("", "{# inline_template_start #}by {{ name }} | {{ created }}", "");
    }
}
